    ...
    <div className="mx-auto max-w-7xl space-y-8 px-4 py-6 sm:px-6 sm:py-8 md:px-8 animate-pulse">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="space-y-2">
          <Skeleton className="h-3.5 w-28 rounded-md bg-stone-200" />
          <Skeleton className="h-8 w-64 rounded-lg bg-stone-300" />
          <Skeleton className="h-4 w-96 max-w-full rounded-md bg-stone-200" />
        </div>
      ...
      <div className="rounded-2xl border border-stone-200 bg-white p-6 shadow-xs space-y-6">
        <div className="flex items-center justify-between">
          <div className="space-y-1.5">
            <Skeleton className="h-5 w-44 rounded-md bg-stone-300" />
            <Skeleton className="h-3.5 w-64 rounded-md bg-stone-200" />
          </div>
